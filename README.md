...
Для полного удаления всех компонентов выберите пункт **`11`** в меню `xry`. Скрипт очистит службы, конфигурации и cron-задачи без затрагивания сторонних сервисов сервера.
